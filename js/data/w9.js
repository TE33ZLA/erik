    ...
    lessons: {
      ...
      'w9-L3': {
        ...
        cards: [
          ...
          { kind: 'ti', title: 'When you do not know E(R) yet',
      ...
      'w9-L5': {
        ...
        cards: [
          ...
          { kind: 'learn', title: 'Past data: divide by N − 1',
      ...
      'w9-L8': {
        ...
        cards: [
          ...
          { kind: 'learn', title: 'The Security Market Line',
            body: R`Draw CAPM as a chart: beta along the bottom, expected return up the side. The straight line is the **Security Market Line** (SML). It starts at \(r_f\) and passes through the market (M) at \(\beta = 1\).\n\nA fairly priced share sits **on** the line. A share **above** the line offers more than CAPM requires: it is **undervalued**, so buy. A share **below** the line is **overvalued**, so sell.`,
            ...
            tip: R`Share 3 needs only \(8\% + 1.3(4\%) = ${pc(FIN.capm(0.08, 1.3, 0.12), 1)}\), but it is expected to earn 15%. It plots above the line: undervalued.` },
